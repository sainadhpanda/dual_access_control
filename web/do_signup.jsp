        ...
        <div class="services-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <br><br><br><br>
                        <img src="img/reg.jpg" width="500" height="550" />
                    </div>
                    <div class="col-md-6">
                        <div class="section-heading">
                            <center><h2>Data Owner Register</h2></center>
                        </div>
                        <div class="contact-form">
                            <form id="contact" action="do_reg" method="post">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <fieldset>
                                            <label>Name :</label>
                                            <input name="username" type="text"  placeholder="Enter Your Name" required="required">
                                        </fieldset>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <fieldset>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <fieldset>
                                            ...
                                            <input name="phone" type="text"  placeholder="Enter Your Phone No" required="required">
                                        </fieldset>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <fieldset>
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="btn btn-primary btn-lg">Sign Up</button><br><br><br><br>
                                        </fieldset>
                                    </div>
                                </div>
                            </form>
