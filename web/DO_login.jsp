    ...
    <body>
        ...
        <div class="services-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="img/dologin.png" width="500" height="400" />
                    </div>
                    <div class="col-md-6">
                        <div class="section-heading">
                            <center><h2>Data Owner Login</h2></center>
                        </div>
                        <div class="contact-form">
                            <form id="contact" action="do_signin.jsp" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="btn btn-success btn-lg">Login</button>&nbsp;&nbsp;&nbsp;
                                            <a href="do_signup.jsp" id="form-submit" class="btn btn-primary btn-lg">Register!</a><br><br><br><br>
                                        </fieldset>
                                    </div>
                                </div>
                            </form>
