                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="contact-form">
                            ...
                            %>
                            <form id="contact" action="view_requested1.jsp" method="post">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <fieldset>
                                            <input type="hidden" value="<%=fid%>" name="fid">
                                            <input type="hidden" value="<%=time%>" name="time">
                                            <label>Decryption Key 1 :</label>
                                            <input name="dkey" type="text"  placeholder="Enter Decryption Key 1" autocomplete="off" required="required">
                                        </fieldset>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <fieldset>
                                            <label>Decryption Key 2 :</label>
                                            <input name="dkey1" type="text" placeholder="Enter Decryption Key 2" autocomplete="off" required="required">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-12">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="btn btn-success btn-lg">Verify</button><br><br><br><br><br>
                                        </fieldset>
                                    </div>
                                </div>
                            </form>
