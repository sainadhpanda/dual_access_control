    ...
    <body>
        ...
        <div class="services-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="img/dulogin.jpg" width="500" height="400" />
                    </div>
                    <div class="col-md-6">
                        <div class="section-heading">
                            <center><h2>Data User Login</h2></center>
                        </div>
                        <div class="contact-form">
                            <form id="contact" action="du_signin.jsp" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset>
                                            ...
                                            <a href="du_signup.jsp" id="form-submit" class="btn btn-primary btn-lg">Register!</a><br><br><br><br>
                                        </fieldset>
                                    </div>
                                </div>
                            </form>
