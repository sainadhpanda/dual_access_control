...
<%
    ...
    try {
        int i = sto.executeUpdate("update request set authority_status='Approved' where id='" + rid + "' ");
        ...
        if (i != 0) {
            ...
            if (rs.next()) {
                ...
                String msggg = "Authority Center Approved Your File Request\nFilename : "+fname+"\nDecryption Key1 : " + dkey;
                Mail ma = new Mail();
                ma.secretMail(msggg, "File_Approved", mail);
                String msg = "File_Approved" + msggg;
                System.out.println("success");
                response.sendRedirect("Authority_request.jsp?Approved");
            } else {
