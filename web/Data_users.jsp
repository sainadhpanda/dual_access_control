                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
                            <center><h2>My Files</h2></center><br>
                        </div>
                        <table id="customers">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><i><a href="du_approve.jsp?id=<%=rs.getString("id")%>&email=<%=rs.getString("email")%>" class="btn btn-success btn-fill btn-circle fa fa-check" style="color: white ; width: 40px; height: 40px"></a></i></td>
                            </tr>
                            <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
